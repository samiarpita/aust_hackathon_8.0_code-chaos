...
-- Courses RLS: Faculty can only CRUD their own courses
...
-- Exams RLS: Faculty can only access exams for their own courses
...
-- ------------------------------------------------------------------------------
-- STORAGE BUCKETS (Optional for file uploads like PDF question papers)
-- ------------------------------------------------------------------------------
